- 每日任务
	...
	- **复习**
		- query-table:: false
		  ...
		  #+END_QUERY
		- {{cards [[模型分析]] }}
			- Summary: 9 items, 9 review counts [[Nov 26th, 2023]]
				- Remembered:   9 (100%)
				- Forgotten :   0 (0%)r
			- Summary: 3 items, 3 review counts [[Nov 26th, 2023]]
				- Remembered:   3 (100%)
				- Forgotten :   0 (0%)
			- Summary: 18 items, 5 review counts [[Nov 26th, 2023]]
				- Remembered:   5 (100%)
				- Forgotten :   0 (0%)
			- Summary: 13 items, 13 review counts [[Nov 26th, 2023]]
				- Remembered:   13 (100%)
				- Forgotten :   0 (0%)rs
	- #+BEGIN_QUERY
	  {:title [:h4 "🎯 所有计划"]
